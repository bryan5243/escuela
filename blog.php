...
<div class="bg-light py-5">
      <div class="container"> 
            <h1 class="display-3 font-weight-bold text-center">Comunicados de Última Hora</h1>
          <div class="owl-carousel testimonial-carousel">
              <?php foreach ($registros as $row): ?>
              <div class="testimonial">
                  <div class="d-flex align-items-center mb-5">
                  <img class='img-fluid center' style="width: 700px; height: 700px;" src='./web2/img/<?= htmlspecialchars($row['foto']); ?>'> 
                  </div>
              </div>
              
              <!-- Agrega más elementos similares según sea necesario -->
              <?php endforeach; ?>
          </div>
      </div>
  </div>
...
$(document).ready(function() {
    var numItemsToShow = <?= $numRegistros; ?> > 1 ? 1 : <?= $numRegistros; ?>;
