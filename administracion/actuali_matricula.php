...
<div class="form-container" style="display: flex; flex-wrap: wrap;">
    <div class="form">
        ...
        <input type="file" name="imagen" id="fileInput1" class="custom-file-input" onchange="validarImagen(event, 'imagen-preview1', 'mensaje-error1')" >
        ...
        <?php if (isset($imageSrc)) : ?>
            <img id="imagen-preview1" src="<?php echo $imageSrc; ?>" class="preview" style="width: 148px; height: 184px;">
        <?php else : ?>
...
<div class="form-container" style="display: flex; flex-wrap: wrap;">
    <div class="form">
        ...
        <input class="input" type="text" id="cedula_estudiante" name="cedula_estudiante"  value="<?php echo $estudiante['cedula']; ?>" oninput="this.value = this.value.replace(/[^0-9]/g, '').slice(0, 10)" required>
        <span class="input-border"></span>
    </div>
</div>
...
<div class="form-container" style="display: flex; flex-wrap: wrap;">
    ...
    <div class="form">
        ...
        <input class="input" type="text" id="apellidos_estudiante" name="apellidos_estudiante" oninput="validarTexto(this)" value="<?php echo $estudiante['apellidos']; ?>" required>
        <span class="input-border"></span>
    </div>
    ...
    <div class="form">
        ...
        <input type="text" class="input" id="nombres_estudiante" name="nombres_estudiante" oninput="validarTexto(this)" value="<?php echo $estudiante['nombres']; ?>" required>
        <span class="input-border"></span>
    </div>
    ...
    <div class="form">
        ...
        <input type="text" class="input" id="lugar_nacimiento_estudiante" name="lugar_nacimiento_estudiante" value="<?php echo $estudiante['lugar_nacimiento']; ?>" required>
        <span class="input-border"></span>
    </div>
    <div class="form">
        ...
        <input type="text" class="input" id="residencia_estudiante" name="residencia_estudiante" value="<?php echo $estudiante['residencia']; ?>" required>
        <span class="input-border"></span>
    </div>
</div>
...
<div class="form-container" style="display: flex; flex-wrap: wrap;">
    ...
    <div class="form">
        ...
        <input type="text" class="input" id="direccion_estudiante" name="direccion_estudiante" value="<?php echo $estudiante['direccion']; ?>" required>
        <span class="input-border"></span>
    </div>
    ...
    <div class="form">
        ...
        <input type="text" class="input" id="sector_estudiante" name="sector_estudiante" value="<?php echo $estudiante['sector']; ?>" required>
        <span class="input-border"></span>
    </div>
    <div class="form">
        ...
        <input type="date" class="input" id="fecha_nacimiento_estudiante" name="fecha_nacimiento_estudiante" value="<?php echo $estudiante['fecha_nacimiento']; ?>" required>
        <span class="input-border"></span>
    </div>
            ...
            try {
                ...
                if ($result->rowCount() > 0) {
                    foreach ($result as $row) {
                        $selected = ($row["id"] == $preestudiante_grado) ? "selected" : "";
...
<div class="form-container" style="display: flex; flex-wrap: wrap;">
    ...
    <div class="form">
        ...
        <select class="input" id="id_paralelo_estudiante" name="id_paralelo_estudiante" required>
            ...
            try {
                ...
                $selected_grado_id = isset($_POST['grado']) ? $_POST['grado'] : $preestudiante_grado;

                if ($selected_grado_id !== null) {
                    $sql = "SELECT id, paralelo FROM paralelo WHERE  id_grados = $selected_grado_id";
                    $result = $conn->query($sql);

                    // Llenar las opciones del select con los datos de la base de datos
                    if ($result->rowCount() > 0) {
                        foreach ($result as $row) {
                            $selected = ($row["id"] == $preestudiante_paralelo) ? "selected" : "";
                            echo "<option value='" . $row["id"] . "' $selected>" . $row["paralelo"] . "</option>";
                        }
                    } else {
    ...
    <div class="form">
        ...
        <input type="text" class="input" id="codigo_unico_estudiante" name="codigo_unico_estudiante" oninput="this.value = this.value.replace(/[^0-9]/g, '').slice(0, 10)" value="<?php echo $estudiante['codigo_unico']; ?>" required>
        <span class=" input-border"></span>
    </div>
...
<div class="form-container" style="display: flex; flex-wrap: wrap;">
    <div class="form">
        ...
        <input type="text" class="input" id="tipo_discapacidad" name="tipo_discapacidad" value="<?php echo isset($tipoDiscapacidad) ? $tipoDiscapacidad : ''; ?>" data-valor="<?php echo isset($tipoDiscapacidad) ? $tipoDiscapacidad : ''; ?>" required disabled>
    ...
    <div class="form">
        ...
        <input type="text" class="input" id="porcentaje_discapacidad" name="porcentaje_discapacidad" value="<?php echo isset($porcentajeDiscapacidad) ? $porcentajeDiscapacidad : ''; ?>" data-valor="<?php echo isset($porcentajeDiscapacidad) ? $porcentajeDiscapacidad : ''; ?>" required disabled>
        <span class="input-border"></span>
    </div>
